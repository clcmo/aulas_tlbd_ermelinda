...
-- Neste exemplo prático, vamos desvendar a consulta de dados de uma tabela
-- Vamos também selecionar, ordenar, agrupar neste primeiro momento
...
INSERT INTO `estado` (`id_uf`, `nome`, `uf`, `ibge`, `pais`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
INSERT INTO cidade (`id_cid`, `nome`, `id_uf`, `ibge`) VALUES
...
ALTER TABLE cidade
  ...
  ADD FOREIGN KEY (id_uf) references estado(id_uf);
  

/*SELECT cidade.nome AS Nome_Cidade, estado.nome AS UF
FROM cidade, estado
ORDER BY estado.id_uf;*/

SELECT cidade.nome AS Nome_Cidade, estado.nome AS UF
FROM cidade, estado
WHERE estado.id_uf = 26
ORDER BY cidade.id_cid;
...
FROM cliente, cidade
WHERE cliente.id_cid = cidade.id_cid;
